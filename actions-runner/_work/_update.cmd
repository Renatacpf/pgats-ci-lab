...
set rootfolder=C:\Users\User\Renata\PosGraduacao\ProjetosJavaScript\pgats-ci-lab\actions-runner
set existrunnerversion=2.324.0
set downloadrunnerversion=2.325.0
set logfile=C:\Users\User\Renata\PosGraduacao\ProjetosJavaScript\pgats-ci-lab\actions-runner\_diag\SelfUpdate-20250605-153236.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\Users\User\Renata\PosGraduacao\ProjetosJavaScript\pgats-ci-lab\actions-runner\run.cmd"
) else (
  endlocal
)
